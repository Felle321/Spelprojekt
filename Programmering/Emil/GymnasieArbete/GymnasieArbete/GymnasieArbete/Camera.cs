...
namespace GymnasieArbete
{
    public class Camera
    {
        ...
        public static float minZoom = .8f;
        ...
        public void Update(Random rand)
        {
            if (Game1.reassEffects)
            {
                ...
                if (Math.Abs(zoom - zoomTarget) < .001f)
                {
                    zoom = zoomTarget;
                }
                else
                {
                    ...
                    {
                        zoom += (zoomTarget - zoom) * World.cameraZoomOutSpeed;
                    }
                    else
                        zoom += (zoomTarget - zoom) * World.cameraZoomInSpeed;
                }
            }
            else
            {
            ...
            rectangle = new Rectangle(Game1.CeilAdv(pos.X - World.screenWidth * .5f / zoom) - 32, Game1.CeilAdv(pos.Y - World.screenHeight * .5f / zoom) - 32, Game1.CeilAdv(World.screenWidth / zoom) + 64, Game1.CeilAdv(World.screenHeight / zoom) + 64);
