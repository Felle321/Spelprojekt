...
namespace GymnasieArbete
{
    public static class SpriteHandler
    {
        ...
        public static void Draw(string key, Random rand, SpriteBatch spriteBatch, Camera camera, Vector2 position)
        {
            sprites[key].Draw(rand, spriteBatch, camera, position);
        }
        ...
        public static void Draw(string key, Random rand, SpriteBatch spriteBatch, Camera camera, Vector2 position, Vector2 vector2Scale)
        {
            sprites[key].Draw(rand, spriteBatch, camera, position, vector2Scale);
        }
        ...
        public static void Draw(string key, Random rand, SpriteBatch spriteBatch, Camera camera, Vector2 position, float scale, float angle, Vector2 origin, Color color, float opacity)
        {
            sprites[key].Draw(rand, spriteBatch, camera, position, scale, angle, origin, color, opacity);
        }
        ...
        /// <param name="color"></param>
        /// <param name="origin"></param>
        public static void Draw(string key, Random rand, SpriteBatch spriteBatch, Camera camera, Vector2 position, Vector2 vector2Scale, float angle, Vector2 origin, Color color, float opacity)
        {
            sprites[key].Draw(rand, spriteBatch, camera, position, vector2Scale, angle, origin, color, opacity);
        }
        ...
        public static Sprite InstantiateSprite(string key)
        {
            ...
            spr.HUD = oldSpr.HUD;
            spr.spriteEffect = oldSpr.spriteEffect;
