...
namespace GymnasieArbete
{
    public static class Extensions
    {
        ...
        public static string ExportString(this Point p)
        {
            return p.X.ToString() + "_" + p.Y.ToString();
        }

        public static string ExportString(this Rectangle r)
        {
            return r.X.ToString() + "_" + r.Y.ToString() + "_" + r.Width.ToString() + "_" + r.Height.ToString();
        }
    }
}
