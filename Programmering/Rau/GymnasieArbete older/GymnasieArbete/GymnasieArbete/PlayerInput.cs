        ...
        public void Update(Player player, Room room)
        {
            ...
            if (Controller_Connected)
            {
                ...
                if (leftHand)
                {
                    ...
                    else if (Game1.ControllerPrev.Buttons.LeftShoulder == ButtonState.Pressed && Game1.Controller.Buttons.LeftShoulder == ButtonState.Released && e_attacks == e_Attacks.a2)
                    {
                        releaseCharge = true;
                ...
                else
                {
                    ...
                    else if (Game1.ControllerPrev.Buttons.RightShoulder == ButtonState.Pressed && Game1.Controller.Buttons.RightShoulder == ButtonState.Released && e_attacks == e_Attacks.a2)
                    {
                        releaseCharge = true;
                        e_attacks = e_Attacks.a0;
                    }
