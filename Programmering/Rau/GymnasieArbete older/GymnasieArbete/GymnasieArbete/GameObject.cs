...
namespace GymnasieArbete
{
    public abstract class GameObject
    {
        ...
        /// <param name="spriteBatch"></param>
        /// <param name="camera">The active camera</param>
        public virtual void Draw(Random rand, SpriteBatch spriteBatch, GraphicsDevice graphics, Camera camera, Color color)
        {
            if (sprite != "")
                SpriteHandler.Draw(sprite, rand, spriteBatch, camera, position, 1f, angle, Origin, color, 1f,SpriteEffects.None, 0.5f);
        }
