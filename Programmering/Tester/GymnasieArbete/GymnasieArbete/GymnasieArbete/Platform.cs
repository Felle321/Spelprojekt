...
namespace GymnasieArbete
{
    public class Platform
    {
        ...
        public void Initialize(List<Platform> platforms, List<Slope> slopes)
        {
        ...
        public virtual void Draw(Point offset, GraphicsDevice graphicsDevice, SpriteBatch spriteBatch)
        {
            ...
            {
                if (usable)
                    Game1.DrawRectangle(graphicsDevice, spriteBatch, new Rectangle(rectangle.X + offset.X, rectangle.X + offset.X, rectangle.Width, rectangle.Height), Color.Green);
                else
                    Game1.DrawRectangle(graphicsDevice, spriteBatch, new Rectangle(rectangle.X + offset.X, rectangle.X + offset.X, rectangle.Width, rectangle.Height), Color.Red);
            }
            else
            {
                if (usable)
                    Game1.DrawRectangle(graphicsDevice, spriteBatch, new Rectangle(rectangle.X + offset.X, rectangle.X + offset.X, rectangle.Width, rectangle.Height), Color.Blue);
                else
                    Game1.DrawRectangle(graphicsDevice, spriteBatch, new Rectangle(rectangle.X + offset.X, rectangle.X + offset.X, rectangle.Width, rectangle.Height), Color.Black);
            }
        }
