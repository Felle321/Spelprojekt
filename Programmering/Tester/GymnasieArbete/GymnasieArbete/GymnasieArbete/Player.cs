...
namespace GymnasieArbete
{
    public class Player : GameObject
    {
        ...
        public override void Update(Room room, Random rand)
        {
            ...
            if (onGround && (!keyboard.IsKeyDown(Keys.Right) && !keyboard.IsKeyDown(Keys.Left)))
            {
                state = State.idle;
        ...
        public override void Draw(Point offset, Random rand, SpriteBatch spriteBatch, GraphicsDevice graphics, Camera camera)
        {
            ...
            switch (state)
            {
                ...
                case State.idle:
                    SpriteHandler.Draw(spr_idle, rand, spriteBatch, camera, new Vector2(drawPos.X + offset.X, drawPos.Y + offset.Y), 1f, 0f, Vector2.Zero, Color.White, 1, spriteEffect, 0.5f);
                    break;
                case State.running:
                    SpriteHandler.Draw(spr_running, rand, spriteBatch, camera, new Vector2(drawPos.X + offset.X, drawPos.Y + offset.Y), 1f, 0f, Vector2.Zero, Color.White,1 , spriteEffect, 0.5f);
                    break;
                case State.dash:
                    SpriteHandler.Draw(spr_dash, rand, spriteBatch, camera, new Vector2(drawPos.X + offset.X, drawPos.Y + offset.Y), 1f, 0f, Vector2.Zero, Color.White, 1, spriteEffect, 0.5f);
                    break;
                case State.back:
                    SpriteHandler.Draw(spr_back, rand, spriteBatch, camera, new Vector2(drawPos.X + offset.X, drawPos.Y + offset.Y), 1f, 0f, Vector2.Zero, Color.White, 1, spriteEffect, 0.5f);
                    break;
                case State.jump:
                    SpriteHandler.Draw(spr_jump, rand, spriteBatch, camera, new Vector2(drawPos.X + offset.X, drawPos.Y + offset.Y), 1f, 0f, Vector2.Zero, Color.White, 1, spriteEffect, 0.5f);
                    break;
                case State.fall:
                    SpriteHandler.Draw(spr_fall, rand, spriteBatch, camera, new Vector2(drawPos.X + offset.X, drawPos.Y + offset.Y), 1f, 0f, Vector2.Zero, Color.White, 1, spriteEffect, 0.5f);
                    break;
                case State.stall:
                    SpriteHandler.Draw(spr_stall, rand, spriteBatch, camera, new Vector2(drawPos.X + offset.X, drawPos.Y + offset.Y), 1f, 0f, Vector2.Zero, Color.White, 1, spriteEffect, 0.5f);
                    break;
                default:
                    break;
            }
