...
namespace GymnasieArbete
{
    public abstract class GameObject
    {
        ...
        {
            if (sprite != "")
                SpriteHandler.Draw(sprite, rand, spriteBatch, camera, new Vector2(position.X + offset.X, position.Y + offset.Y), SpriteEffects.None,0.5f);
        }
        ...
        /// <param name="spriteBatch"></param>
        public virtual void DrawCol(Point offset, GraphicsDevice graphicsDevice, SpriteBatch spriteBatch)
        {
        ...
        {
            if(spriteLight != null)
                SpriteHandler.Draw(spriteLight, rand, spriteBatch, camera, position + offset.ToVector2(), SpriteEffects.None, 0.5f);
        }
