...
namespace GymnasieArbete
{
    public class Projectile : GameObject
    {
        ...
        {
            animation.Draw(rand, spriteBatch, camera, new Vector2(position.X + offset.X, position.Y + offset.Y), 1f, angle, new Vector2(animation.Width/2, animation.Height/2), Color.White, 1f, SpriteEffects.None, 0.5f);
        }

        public override void DrawCol(Point offset, GraphicsDevice graphics, SpriteBatch spriteBatch)
        {
            Game1.DrawRectangle(graphics, spriteBatch, new Rectangle(Rectangle.X + offset.X, Rectangle.Y + offset.Y, Rectangle.Width, Rectangle.Height), Color.Blue);
        }
    }
