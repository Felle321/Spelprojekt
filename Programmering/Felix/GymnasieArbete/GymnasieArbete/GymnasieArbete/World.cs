...
namespace GymnasieArbete
{
    class World
    {
        ...
        public static Color colorForcedDoor = new Color(0, 0, 255);
        ...
        //Percentage
        public static float cameraSpeed = .085f;
        public static float cameraZoomInSpeed = .01f;
        public static float cameraZoomOutSpeed = .04f;
        public static float cameraTorque = 0f;
        ...
        public static int doorHeight = 220;

        //In Game Values
        public const int AttackCD = 10;
        public const int wallJumpDelay = 10;
    }
}