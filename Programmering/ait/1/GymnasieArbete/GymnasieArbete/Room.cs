...
namespace GymnasieArbete
{
    public class Room
    {
        ...
        public void Draw(Random rand, SpriteBatch spriteBatch, Camera camera, GraphicsDevice graphicsDevice)
        {
            for (int i = 0; i < gameObjects.Count; i++)
            {
                gameObjects[i].Draw(rand, spriteBatch, camera, graphicsDevice);
            }
