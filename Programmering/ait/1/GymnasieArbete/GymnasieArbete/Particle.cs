...
namespace GymnasieArbete
{
    public abstract class Particle
    {
        ...
        public class Fire : Particle
        {
            ...
            {
                SpriteHandler.Draw("gradient", rand, spriteBatch, camera, position - origin * 2, scale, 0, origin, color, opacity, SpriteEffects.None, 0);
            }
        }
        ...
        public class Dynamic : GameObject
        {
            ...
            public Dynamic(Rectangle rectangle, int level, Room newRoom, string spriteKey, bool pixel, Color color, float scale, int duration, bool impact, bool additive) : base(rectangle, level, newRoom, spriteKey)
            {
                hp = duration;
                this.color = color;
                this.scale = scale;
