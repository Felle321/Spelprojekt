...
namespace GymnasieArbete
{
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            player.leftHand = Weapons["RedBlaster"];
        ...
        protected override void Update(GameTime gameTime)
        {
            if (delay == 0)
            {
                ...
                if (!paused)
                {
                    ...
                    {
                        rooms[roomString].gameObjects.Add(new Enemy.Test(new Vector2(100, 100), rooms[roomString], level, new Animation("GroundTroop_Idle"), 0, 0));
                    }
